...
class MedicalRecordController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('veterinarian.medical.index', compact('records', 'owners', 'generatedCode'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $msg = $isPaid 
            ...
            : "Patient examination recorded ({$recordCode}) and sent to Cashier Billing queue ({$invoiceNo})!";
    ...
    public function update(Request $request, MedicalRecord $record)
    {
        ...
        $msg = $validated['status'] === 'completed'
            ...
            : "Record {$record->record_code} updated successfully and synced with Central Billing ({$invoiceNo}).";
