...
class LeaveController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('manager.leaves.index', compact('leaves', 'employees', 'leaveStats', 'slMonetization', 'year', 'archivedLedgers', 'allArchivedYears'));
    }
    ...
    public function printLedger(int $year)
    {
        ...
        return view('manager.leaves.ledger_print', compact('ledgers', 'year'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $leave = LeaveApplication::create([
            ...
            'status' => 'approved', // Direct filing defaults to approved
            'is_paid' => $isPaid,
        ...
        return redirect()->route('manager.leaves.index')->with('success', 'Leave application recorded and processed successfully!');
    }
