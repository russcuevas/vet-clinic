...
class LeaveController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('manager.payroll.leaves.index', compact('leaves', 'employees', 'leaveStats', 'slMonetization', 'year', 'archivedLedgers', 'allArchivedYears'));
    }
    ...
    public function printLedger(int $year)
    {
        ...
        return view('manager.payroll.leaves.ledger_print', compact('ledgers', 'year'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('manager.payroll.leaves.index')->with('success', 'Leave application recorded and processed successfully!');
    }
