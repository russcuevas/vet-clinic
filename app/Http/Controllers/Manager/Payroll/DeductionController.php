...
class DeductionController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('manager.payroll.deductions.index', compact('deductions', 'employees', 'totalActiveLoans', 'totalActiveCashAdvance'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('manager.payroll.deductions.index')->with('success', 'Deduction / Financial account logged successfully!');
    }
    ...
    public function update(Request $request, Deduction $deduction)
    {
        ...
        return redirect()->route('manager.payroll.deductions.index')->with('success', 'Deduction record updated successfully!');
    }

    public function destroy(Deduction $deduction)
    {
        $deduction->delete();
        return redirect()->route('manager.payroll.deductions.index')->with('success', 'Deduction deleted.');
    }
}
