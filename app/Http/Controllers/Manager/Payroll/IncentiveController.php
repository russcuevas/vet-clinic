...
class IncentiveController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('manager.payroll.incentives.index', compact(
            'rules',
            'incentives',
            'employees',
            'month',
    ...
    public function updateRule(Request $request, IncentiveRule $rule)
    {
        ...
        return redirect()->route('manager.payroll.incentives.index')->with('success', "Incentive rule '{$rule->title}' successfully updated!");
    }
    ...
    public function storeRule(Request $request)
    {
        ...
        return redirect()->route('manager.payroll.incentives.index')->with('success', 'New incentive scheme created successfully!');
    }
    ...
    public function storeEmployeeIncentive(Request $request)
    {
        ...
        return redirect()->route('manager.payroll.incentives.index', [
