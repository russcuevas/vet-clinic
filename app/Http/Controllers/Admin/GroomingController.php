...
class GroomingController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->back()->with('success', "Grooming entry saved ({$code}) and queued in Billing ({$invoiceNo})!");
    }
    ...
    public function update(Request $request, GroomingRecord $grooming)
    {
        ...
        return redirect()->back()->with('success', "Grooming record {$grooming->grooming_code} and Billing database updated successfully!");
    }
