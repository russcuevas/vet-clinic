            ...
            <div class="card-header" style="flex-direction: column; align-items: stretch; gap: 0.85rem;">
                <div style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 0.5rem;">
                    ...
                    <div class="search-input-wrapper" style="min-width: 220px;">
                        ...
                        <input type="text" class="form-control" placeholder="Search items, vaccines, medicine..." id="supply-search-input">
                    </div>
                </div>
                        ...
                        <div class="supply-item-card" 
                            ...
                            <div>
                                @if($item->image && file_exists(public_path($item->image)))
                                    <div style="width: 100%; height: 110px; border-radius: var(--radius-sm); overflow: hidden; margin-bottom: 0.6rem; background: var(--black-bg); border: 1px solid rgba(255,255,255,0.06);">
                                ...
                                <h4 style="font-size: 0.88rem; font-weight: 700; color: var(--white); margin-bottom: 0.35rem; line-height: 1.3;">{{ $item->name }}</h4>
                                @if($item->description)
                                    <p style="font-size: 0.72rem; color: var(--text-muted); margin-bottom: 0.5rem; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden;">{{ $item->description }}</p>
                                @endif
                            </div>
                            <div style="margin-top: 0.5rem; padding-top: 0.5rem; border-top: 1px solid rgba(255,255,255,0.05);">
                                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.35rem;">
                                    ...
                                    <span style="font-size: 0.7rem; color: {{ $item->stock_quantity <= ($item->reorder_level ?? 5) ? 'var(--danger)' : 'var(--text-muted)' }}; font-weight: 600;">
                                        {{ $item->stock_quantity }} {{ $item->unit }}
                                    </span>
                                </div>
                                <button type="button" class="btn {{ $item->stock_quantity > 0 ? 'btn-gold' : 'btn-navy' }} btn-sm" style="width: 100%; padding: 3px 8px; font-size: 0.75rem;" {{ $item->stock_quantity <= 0 ? 'disabled' : '' }}>
