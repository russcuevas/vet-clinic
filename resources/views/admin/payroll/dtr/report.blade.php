...
<body>
    ...
    <div class="dtr-page-container">
        ...
        <div class="toolbar no-print">
            <div>
                <a href="{{ route('admin.payroll.dtr.index') }}" class="btn btn-back">
        ...
        <div class="signatures-container">
            ...
            <div class="sig-box">
                <div class="sig-line"></div>
                <div class="sig-name">{{ auth()->check() ? auth()->user()->name : 'Clinic Administrator' }}</div>
                <div class="sig-title">Verified & Approved In-Charge / Clinic Admin</div>
            </div>
        </div>
    </div>
    ...
    <div class="modal-overlay no-print" id="editDayModal">
        <div class="modal-box">
            ...
            <form action="{{ route('admin.payroll.dtr.quick_update') }}" method="POST" id="quickEditForm">
                @csrf
