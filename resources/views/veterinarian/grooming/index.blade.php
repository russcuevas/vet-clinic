...
@section('content')
    ...
    <div class="table-toolbar">
        <div style="display: flex; gap: 0.75rem; align-items: center; flex-wrap: wrap;">
            ...
            <div style="display: flex; gap: 0.35rem;">
                <a href="{{ route('vet.grooming.index') }}" class="btn btn-sm {{ !request('status') ? 'btn-gold' : 'btn-navy' }}">All</a>
                <a href="{{ route('vet.grooming.index', ['status' => 'queued']) }}" class="btn btn-sm {{ request('status') === 'queued' ? 'btn-gold' : 'btn-navy' }}">Queued</a>
                <a href="{{ route('vet.grooming.index', ['status' => 'in_progress']) }}" class="btn btn-sm {{ request('status') === 'in_progress' ? 'btn-gold' : 'btn-navy' }}">In Progress</a>
                <a href="{{ route('vet.grooming.index', ['status' => 'completed']) }}" class="btn btn-sm {{ request('status') === 'completed' ? 'btn-gold' : 'btn-navy' }}">Completed</a>
            </div>
        </div>
                                ...
                                <td style="text-align: right;">
                                    <div style="display: inline-flex; gap: 0.4rem;">
                                        ...
                                        <button type="button" class="btn btn-danger btn-sm"
                                            ...
                                            data-action-url="{{ route('vet.grooming.destroy', $groom->id) }}"
    ...
    <div class="modal-backdrop" id="modal-new-grooming">
        <div class="modal-dialog modal-lg">
            ...
            <form action="{{ route('vet.grooming.store') }}" method="POST">
                @csrf
