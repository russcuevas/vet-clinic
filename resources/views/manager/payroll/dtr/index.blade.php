...
@section('content')
    ...
    <div class="card" style="margin-bottom: 1.25rem;">
        <div class="card-body" style="padding: 0.85rem 1.25rem;">
            <form method="GET" action="{{ route('manager.payroll.dtr.index') }}" id="dtr-date-form"
                ...
                <div style="display: flex; align-items: center; gap: 0.75rem; flex-wrap: wrap;">
                    ...
                    <a href="{{ route('manager.payroll.dtr.index', ['date' => now()->toDateString()]) }}"
                                ...
                                <tr
                                    ...
                                    <td style="padding: 14px 16px; vertical-align: middle;">
                                        <div
                                            ...
                                            <!-- Clock In Form -->
                                            <form action="{{ route('manager.payroll.dtr.store') }}" method="POST"
                                                style="display: flex; align-items: center; gap: 6px; margin: 0; flex-wrap: nowrap;">
                                                @csrf
                                            ...
                                            <form action="{{ route('manager.payroll.dtr.store') }}" method="POST" id="tag_form_{{ $emp->id }}" style="margin: 0; display: inline-flex; align-items: center;">
                                                @csrf
                                                <input type="hidden" name="employee_id" value="{{ $emp->id }}">
                                                <input type="hidden" name="record_date" value="{{ $selectedDate }}">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div style="display: flex; gap: 0.35rem; align-items: center;">
                                            ...
                                            <form action="{{ route('manager.payroll.dtr.destroy', $dtr) }}" method="POST"
    ...
    <div class="modal-backdrop" id="modal-batch-dtr">
        <div class="modal-dialog" style="max-width: 500px;">
            ...
            <form action="{{ route('manager.payroll.dtr.batch') }}" method="POST">
                @csrf
                <div class="modal-body" style="padding: 1.5rem;">
                    <div class="form-group">
    ...
    <!-- Modal: Payroll Rate Multipliers & Settings (Manager Only) -->
    <div class="modal-backdrop" id="modal-payroll-multipliers">
        <div class="modal-dialog" style="max-width: 540px;">
            ...
            <form action="{{ route('manager.payroll.settings.multipliers.update') }}" method="POST">
                @csrf
                <div class="modal-body" style="padding: 1.5rem;">
