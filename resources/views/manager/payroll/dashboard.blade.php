...
@section('content')
    ...
    <div style="display: flex; gap: 0.75rem; flex-wrap: wrap; margin-bottom: 2rem;">
        <a href="{{ route('manager.payroll.periods.index') }}" class="btn btn-gold">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" />
            </svg>
            <span>+ Generate Payroll (15/30 Days)</span>
        </a>
        <a href="{{ route('manager.payroll.employees.index') }}" class="btn btn-navy">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z" />
            </svg>
            <span>+ Add Employee</span>
        </a>
        <a href="{{ route('manager.payroll.incentives.index') }}" class="btn btn-navy">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
            </svg>
            <span>Record Incentive %</span>
        </a>
        <a href="{{ route('manager.payroll.dtr.index') }}" class="btn btn-navy">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
            </svg>
            <span>Timekeeping (DTR)</span>
        </a>
        <a href="{{ route('manager.payroll.leaves.index') }}" class="btn btn-navy">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(460px, 1fr)); gap: 1.5rem; margin-bottom: 2rem;">
        ...
        <div class="card">
            <div class="card-header">
                ...
                <a href="{{ route('manager.payroll.periods.index') }}" class="btn btn-ghost btn-sm">View All</a>
            </div>
                        ...
                        <tbody>
                            @forelse($recentPeriods as $period)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('manager.payroll.periods.show', $period) }}" class="btn btn-navy btn-sm" style="padding: 0.3rem 0.65rem;">
                                            Review
                                        </a>
                                    </td>
                                </tr>
        ...
        <div class="card">
            <div class="card-header">
                ...
                <a href="{{ route('manager.payroll.leaves.index') }}" class="btn btn-ghost btn-sm">View Leaves</a>
            </div>
            <div class="card-body" style="padding: 0;">
                <div class="table-responsive">
                    <table class="data-table">
                        ...
                        <tbody>
                            @forelse($pendingLeaveRequests as $leave)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('manager.payroll.leaves.index') }}" class="btn btn-gold btn-sm" style="padding: 0.3rem 0.65rem;">
                                            Action
                                        </a>
                                    </td>
                                </tr>
    ...
    <div class="card">
        <div class="card-header">
            ...
            <a href="{{ route('manager.payroll.incentives.index') }}" class="btn btn-ghost btn-sm">Configure & Manage</a>
        </div>
        <div class="card-body" style="padding: 0;">
            <div class="table-responsive">
                <table class="data-table">
                        ...
                        @empty
                            <tr>
                                <td colspan="7" style="text-align: center; color: var(--text-muted); padding: 2rem;">
                                    No incentives recorded yet this month. Visit <a href="{{ route('manager.payroll.incentives.index') }}" style="color: var(--gold-light);">Role Incentives</a> to record!
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
