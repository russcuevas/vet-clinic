...
@section('content')
    ...
    <div class="card" style="margin-bottom: 1.5rem;">
        <div class="card-body" style="padding: 1rem 1.25rem;">
            <form method="GET" action="{{ route('manager.payroll.deductions.index') }}" style="display: flex; gap: 1rem; flex-wrap: wrap; align-items: center;">
                ...
                @if(request()->anyFilled(['type', 'status', 'employee_id']))
                    <a href="{{ route('manager.payroll.deductions.index') }}" class="btn btn-ghost btn-sm">Reset</a>
                @endif
            </form>
        </div>
    </div>
                        ...
                        @forelse($deductions as $ded)
                            <tr>
                                ...
                                <td>
                                    <div style="display: flex; gap: 0.35rem;">
                                        ...
                                        <form action="{{ route('manager.payroll.deductions.destroy', $ded) }}" method="POST"
                            ...
                            <div class="modal-backdrop" id="modal-edit-ded-{{ $ded->id }}">
                                <div class="modal-dialog" style="max-width: 500px;">
                                    ...
                                    <form action="{{ route('manager.payroll.deductions.update', $ded) }}" method="POST">
                                        @csrf
                                        @method('PUT')
    ...
    <div class="modal-backdrop" id="modal-add-deduction">
        <div class="modal-dialog" style="max-width: 550px;">
            ...
            <form action="{{ route('manager.payroll.deductions.store') }}" method="POST">
                @csrf
                <div class="modal-body" style="padding: 1.5rem;">
                    <div class="form-group">
